...
public static class PlusIconSceneSetup
{
    private const string ModelPath = "Assets/Models/Icons/Plus_Icon.fbx";
    private const string PrefabFolder = "Assets/Prefabs";
    private const string PrefabPath = "Assets/Prefabs/PlusIcon.prefab";
    ...
    private static void CreatePrefab()
    {
        ...
        if (model == null)
        {
            throw new FileNotFoundException("Plus icon model not found.", ModelPath);
        }

        GameObject instance = (GameObject)PrefabUtility.InstantiatePrefab(model);
        instance.name = "PlusIcon";
        Material greenMaterial = AssetDatabase.LoadAssetAtPath<Material>(MaterialPath);
        ...
        for (int i = 0; i < renderers.Length; i++)
        {
            ...
            {
                renderers[i].sharedMaterial = greenMaterial;
            }
    ...
    private static void PlaceIconsInScene()
    {
        ...
        if (prefab == null)
        {
            throw new FileNotFoundException("Plus icon prefab not found.", PrefabPath);
        }
        ...
        for (int i = 0; i < tiles.Length; i++)
        {
            ...
            if (tile == null || !tile.name.Trim().EndsWith("_Tile_3"))
            {
                continue;
            }
